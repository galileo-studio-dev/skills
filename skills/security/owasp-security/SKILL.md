...
This is a read-only guidance skill for secure implementation and review. Treat
its OWASP and ASVS material as the vendored state at the pinned upstream
revision, not as an automatically updated standards source.

For compliance, legal, or audit conclusions, verify the current official
standard and involve the appropriate reviewer. Do not present this skill's
output as certification, legal advice, or a substitute for a formal security
assessment.

## Credits

Adapted from [`owasp-security`](https://github.com/agamm/claude-code-owasp/tree/f5dfa3d66da1fdfeb36b7428c35b17abaff6465b/.claude/skills/owasp-security) by [agamm](https://github.com/agamm). This vendored copy adds this Credits section and company approval notes; the upstream MIT license is included in this skill directory.
